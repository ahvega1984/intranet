...
if (strstr($_SERVER['REQUEST_URI'],'intranet/admin/faltas/index.php')==TRUE) {$activo6 = ' class="active" ';}
...
<div class="container hidden-print">
	...
	<a href="//<?php echo $config['dominio']; ?>/intranet/faltas/preferencias.php" class="btn btn-sm btn-default pull-right" style="margin-left: 5px;"><span class="fas fa-cog fa-lg"></span></a>
	<?php endif; ?>
	...
	<ul class="nav nav-tabs">
		<li <?php echo $activo3;?>><a href="//<?php echo $config['dominio']; ?>/intranet/faltas/index.php">Poner</a></li>
		<?php if (stristr($_SESSION['cargo'],'2') == TRUE or stristr($_SESSION['cargo'],'1') == TRUE or stristr($_SESSION['cargo'],'3') == TRUE): ?>
