...
<FORM ENCTYPE="multipart/form-data" ACTION="subir.php" METHOD="post">
  ...
  <p class="text-info">
  Si el módulo de faltas de asistencia está operativo, es necesario descargar desde Séneca el archivo que se utilizará como base para posteriormente subir las faltas. Se descarga de Seneca desde &quot;Intercambio de Informacion --&gt; Exportación desde Seneca --&gt; Exportación de Faltas de Asistencia del Alumnado&quot;. Arriba a la derecha hay un icono para crear un nuevo documento con los datos de las faltas; seleccionar el día actual como comienzo y final; seleccionar todos los grupos del Centro y añadirlos a la lista. Cuando hayais terminado, haced clic en el icono de confirmación y al cabo de un minuto volved a la página de exportación de faltas de asitencia y veréis que se ha generado un archivo comprimido que podáis descargaros. Es conveniente actualizar los archivos de vez en cuando.
  </p>
