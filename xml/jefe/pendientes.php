...
// Regeneración de la tabla de pendientes
...
$trozos1 = explode(":", $combasi);
 foreach ($trozos1 as $asig)
  {
$curso_r = substr($curso,0,12);
$nombreasig = "select NOMBRE, ABREV, CURSO, CODIGO from asignaturas where CODIGO = '" . $asig . "' and curso like '$curso_r%' and abrev like '%\_%'";
