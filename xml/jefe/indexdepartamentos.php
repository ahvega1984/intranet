...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<p>
			Una vez importados los datos es conveniente ir a la p�gina de <strong>Gesti�n de los Departamentos</strong> para personalizar los datos y adaptar a la estructura real del Centro. Esta tarea debe realizarse cada vez que se importan o actualizan los Departamentos y profesores.
			</p>
