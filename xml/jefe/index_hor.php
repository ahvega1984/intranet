				...
				<form enctype="multipart/form-data" method="post" action="">
					<fieldset>
						...
						<div class="form-group">
						  ...
						  <?php $result = mysqli_query($db_con, "SELECT DISTINCT nombre FROM departamentos WHERE departamento <> 'Admin' AND departamento <> 'Administracion' AND departamento <> 'Conserjeria' AND departamento <> 'Educador' AND departamento <> 'Servicio Técnico y/o Mantenimiento' ORDER BY nombre ASC"); ?>
						  <?php if(mysqli_num_rows($result)): ?>
