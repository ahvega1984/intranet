...
// TABLAS INTOCABLES
$intocables = array("alma_primaria", "alma_secundaria", "biblioteca","actualizacion","calendario","calendario_categorias", "c_profes", "control", "departamentos", "evalua_tutoria", "fotos", "informe_extraordinaria", "informe_extraordinaria_contenidos", "inventario_clases", "inventario", "inventario_lugares", "libros_texto", "libros_texto_alumnos", "listafechorias", "matriculas", "matriculas_bach", "matriculas_backup", "matriculas_bach_backup", "mem_dep", "mensajes", "mens_profes", "mens_texto", "noticias", "partestic", "recursos", "reservas", "reservas_tipos", "reservas_elementos", "r_departamento", "tareas", "temas", "Textos", "textos_gratis", "transito_control", "transito_datos", "transito_tipo");
