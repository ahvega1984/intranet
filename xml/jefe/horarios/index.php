						  ...
						  <select class="form-control" id="asignatura" name="asignatura">
						 	<option value=""></option>
						  	...
						  	<optgroup label="Actividades">
							  	...
							  	<?php else: ?>
							  	<?php $result = mysqli_query($db_con, "SELECT DISTINCT `idactividad`, `nomactividad` FROM `actividades_seneca` WHERE `nomactividad` NOT LIKE 'Docencia%' AND `nomactividad` NOT LIKE 'Tutoría%' AND `nomactividad` NOT LIKE 'Tutor de Ciclo Formativo%' ORDER BY `nomactividad` ASC"); ?>
							  	<?php endif; ?>
							  	<?php while ($row = mysqli_fetch_array($result)): ?>
