					...
					<tbody>
							...
							if(isset($_FILES['archivo'])) {
								...
								while(($row = fgetcsv($file, 1000, "|")) !== FALSE) {
									...
									// Jefe/a Sv. Técnico y/o Mantenimiento = '';
									if(stristr($pas_departamento, 'Jefe/a Sv. Técnico y/o Mantenimiento') == TRUE) {
										...
										if(! $usuarioExiste) {
											// TABLA DEPARTAMENTOS
											mysqli_query($db_con, "INSERT INTO departamentos (NOMBRE, DNI, DEPARTAMENTO, CARGO, idea) VALUES ('".$pas_nombre."', '".$pas_dni."', 'Servicio Técnico y/o Mantenimiento', '', '".$pas_idea."')");
