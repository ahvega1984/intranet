...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
	        ...
	        echo "<thead><th>1ª Hora</th><th>2ª Hora</th><th>3ª Hora</th><th>4ª Hora</th><th>5ª Hora</th><th>6ª Hora</th><th>7ª Hora</th><th>8ª Hora</th></thead><tbody>";
	        while($row = mysqli_fetch_array ( $result ))
            {
	            ...
	            echo "<tr><th colspan='8' style='text-align:center'>";
		        echo "$profe_baja";
		        echo "</th></tr><tr>";
	            $ndia = date ( "w" );
	            for ($i = 1;$i < 9;$i++)
