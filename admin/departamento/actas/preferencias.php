						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" id="prefSecretarioDFEIE" name="prefSecretarioDFEIE">
									<?php $result = mysqli_query($db_con, "SELECT nombre FROM departamentos WHERE departamento <> 'Admin' AND departamento <> 'Administracion' AND departamento <> 'Conserjeria' AND departamento <> 'Educador' AND departamento <> 'Servicio Técnico y/o Mantenimiento' AND cargo LIKE '%f%' ORDER BY nombre ASC"); ?>
									<?php if (mysqli_num_rows($result) > 1): ?>
									<option value=""></option>
									<?php endif; ?>
									<?php while ($row = mysqli_fetch_array($result)): ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" id="prefSecretarioETCP" name="prefSecretarioETCP">
									<option value=""></option>
									<?php $result = mysqli_query($db_con, "SELECT nombre FROM departamentos WHERE departamento <> 'Admin' AND departamento <> 'Administracion' AND departamento <> 'Conserjeria' AND departamento <> 'Educador' AND departamento <> 'Servicio Técnico y/o Mantenimiento' AND cargo LIKE '%9%' ORDER BY nombre ASC"); ?>
									<?php while ($row = mysqli_fetch_array($result)): ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" id="prefSecretarioED" name="prefSecretarioED">
									<?php $result = mysqli_query($db_con, "SELECT nombre FROM departamentos WHERE departamento <> 'Admin' AND departamento <> 'Administracion' AND departamento <> 'Conserjeria' AND departamento <> 'Educador' AND departamento <> 'Servicio Técnico y/o Mantenimiento' AND cargo LIKE '%1%' ORDER BY nombre ASC"); ?>
									<?php while ($row = mysqli_fetch_array($result)): ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select class="form-control" id="prefSecretarioCEB" name="prefSecretarioCEB">
									<option value=""></option>
									<?php $result = mysqli_query($db_con, "SELECT nombre FROM departamentos WHERE departamento <> 'Admin' AND departamento <> 'Administracion' AND departamento <> 'Conserjeria' AND departamento <> 'Educador' AND departamento <> 'Servicio Técnico y/o Mantenimiento' AND cargo LIKE '%a%' ORDER BY nombre ASC"); ?>
									<?php while ($row = mysqli_fetch_array($result)): ?>
