				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<?php for($i = 1; $i < $count_cols; $i++): ?>
							...
							<p><a href="../../reservas/reservar/index_aulas.php?year=<?php echo $anio0;?>&today=<?php echo $dia0;?>&month=<?php echo $mes0;?>&servicio=<?php echo $row['n_aula']; ?>"><?php echo $row['n_aula']; ?></a></p>
