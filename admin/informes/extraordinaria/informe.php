...
?>
	...
	<div class="container">
		...
		<div class="page-header">
			<h2>Informe individual para la evaluación extraordinaria <small> <br>Nuevo informe</small></h2>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="pull-right">
								...
								<a href="//<?php echo $config['dominio']; ?>/intranet/admin/informes/extraordinaria/informe.php?id_informe=<?php echo $informe['id_informe']; ?>" data-bs="tooltip" title="Editar este informe."><span class="text-warning fas fa-edit fa-fw fa-lg"></span></a>
