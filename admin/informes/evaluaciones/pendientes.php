	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-2 hidden-print">
				...
				<a href="pendientes.php?evaluacion=<?php echo $evaluacion_seleccionada; ?>&amp;recalcular=1" class="btn btn-sm btn-warning pull-right"><span class="far fa-refresh fa-fw"></span> Recalcular</a>
				<?php endif; ?>
			</div>
		</div>
