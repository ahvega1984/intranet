...
<div class="container hidden-print">
	...
	<ul class="nav nav-tabs">
		...
		<li<?php if (strstr($_SERVER['REQUEST_URI'],'adaptaciones')==TRUE) echo ' class="active"'; ?>><a href="//<?php echo $config['dominio']; ?>/intranet/admin/departamento/adaptaciones/index.php">ACNS</a></li>
