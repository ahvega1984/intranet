	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<?php $result = mysqli_query($db_con, "SELECT id, titulo, fechapub, autor, pagina FROM noticias where pagina like '%3%' ORDER BY fechapub DESC LIMIT $limit_ini, $limit"); ?>
				...
				<?php if (mysqli_num_rows($result)): ?>
								...
								<?php while ($row = mysqli_fetch_array($result)): ?>
									<tr>
										...
										<td nowrap>
											...
											<a href="permanentes.php?id=<?php echo $row['id']; ?>&amp;borrar=1" data-bb="confirm-delete"><span class="far fa-trash-alt fa-fw fa-lg" data-bs="tooltip" title="Eliminar"></span></a>
											<?php endif; ?>
										</td>
									</tr>
								<?php endwhile; ?>
					...
					<ul class="pager">
					  <li class="previous<?php echo ($pag == $n_paginas || $total < $limit) ? ' disabled' : ''; ?>"><a href="<?php echo ($pag == $n_paginas || $total < $limit) ? '#' : 'permanentes.php?pag='.$pag_sig; ?>">&larr; Antiguas</a></li>
					  <li class="next<?php echo ($pag == 0) ? ' disabled' : '' ?>"><a href="<?php echo ($pag == 0) ? '#' : 'permanentes.php?pag='.$pag_ant; ?>">Recientes &rarr;</a></li>
					</ul>
