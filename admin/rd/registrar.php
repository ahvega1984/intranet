...
if (isset($_GET['organo'])) {
	$uri = 'registrar.php?organo='.$_GET['organo'].'&amp;';
}
else {
	$uri = 'registrar.php?';
}
...
?>
			...
			<div class="col-md-3">
				...
				<?php $result = mysqli_query($db_con, "SELECT * FROM r_departamento WHERE departamento = '$departamento' ORDER BY numero DESC"); ?>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="story.php?id=<?php echo $row['id']; ?>" data-bs="tooltip" title="Ver acta"><span class="fa fa-eye fa-fw fa-lg"></span></a>
								<?php else: ?>
								<?php if (! $row['impreso']): ?>
								<a href="<?php echo $uri; ?>edit_id=<?php echo $row['id']; ?>" data-bs="tooltip" title="Editar acta"><span class="fa fa-edit fa-fw fa-lg"></span></a>
								<a href="pdf.php?id=<?php echo $row['id']; ?>&amp;imprimir=1" data-bs="tooltip" title="Imprimir acta"><span class="fa fa-print fa-fw fa-lg"></span></a>
