...
El Acta del Departamento ha sido registrada correctamente.
		...
		echo '<div align="center"><a href="add_etcp.php" class="btn btn-primary">Volver atrás</a></div>';
		exit();
	}
	else {
...
$d_rd0 = mysqli_query($db_con, "select hora, hora_inicio from tramos where tramos.hora = (select horw.hora from horw where prof = '$pr' and c_asig = '51')");
...
<form method="post" action="add_etcp.php" name="f1">
...
<input type="text" class="form-control" id="jefedep" name="jefedep"
	value="<?php echo $pr; ?>" readonly></div>
