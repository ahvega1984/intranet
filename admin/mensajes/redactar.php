...
=======
              ...
              <?php endif; ?>
>>>>>>> 98e9c333dc1fea3b3385d53e3747a2894478d079
              </div>
              <?php else: ?>
              ...
              <?php endif; ?>
				...
				<div id="grupo_dfeie" class="well <?php echo (isset($dfeie) && !empty($dfeie)) ? '' : 'hidden'; ?>">
					...
					<fieldset>
						...
						<?php $result = mysqli_query($db_con, "SELECT DISTINCT nombre FROM departamentos WHERE cargo LIKE '%f%' ORDER BY nombre ASC");?>
						<?php if(mysqli_num_rows($result)): ?>
						<ul style="height: auto; max-height: 520px; overflow: scroll;">
							<?php while($row = mysqli_fetch_array($result)): ?>
							<li><?php echo $row['nombre'] ; ?></li>
