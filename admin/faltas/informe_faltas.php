...
<div id="status-loading" class="text-center">
    <br><br><span class="lead"><span class="far fa-circle-o-notch fa-spin"></span> Cargando datos...<br><small>El proceso puede tomar algún tiempo (minutos) la primera vez que se realiza esta consulta.</small></span><br><br><span class="fas fa-spinner fa-spin fa-5x"></span>
</div>
