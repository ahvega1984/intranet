			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<li>La siguiente columna permite indicar si el alumno promociona o no promociona. Esta opción se marca automáticamente cuando importamos las calificaciones de la Evaluación Extraordinaria y actualizamos los alumnos. Como Séneca introduce entonces los datos "Promociona" y "Repite" en el archivo de los alumnos, lass opciones SI y NO aparecen marcadas automáticamente en la tabla de consultas para los distintos niveles. Cuando esto sucede, antes de Enviar los datos con el botón de "Enviar datos" debemos seleccionar los alumnos PIL y cambiar la promoción de NO a SI. Una vez terminada la selección de los PIL ya podemos enviar los datos del formulario. Al procesarse la información eviada, los alumnos se recolocan de acuerdo a si promocionan o no promocionana (en este caso el alumno repetidor volverá al curso que repite y desaparecerá del curso en el que se había matriculado).<br>
