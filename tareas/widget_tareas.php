...
<div class="well well-sm">
	...
	<div class="list-group">
		...
		<a class="list-group-item" href="//<?php echo $config['dominio']; ?>/intranet/tareas/tarea.php?id=<?php echo $row_tareas['id']; ?>">
            <div class="row">
                <div class="col-sm-2">
                    <form action="" method="post">
                        <input type="hidden" name="id_tarea" value="<?php echo $row['id']; ?>">
                        <button type="submit" name="submit_tarea" class="btn btn-xs btn-default"><span class="fa fa-check fa-fw"></span></button>
                    </form>
                </div>
                <div class="col-sm-10">
