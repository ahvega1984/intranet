    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8">
                ...
                <?php if (isset($_SESSION['pagina_centro']) && $_SESSION['pagina_centro'] == 1): ?>
                <p>Puedes comprobar que tu información de contacto sean correctas, estén completas y se mantengan actualizadas en todo momento accediendo a la página de <a href="//<?php echo $config['dominio']; ?>/alumnado/" target="_blank">Alumnado</a> si eres alumno o tutor legal, o accediendo a la <a href="//<?php echo $config['dominio']; ?>/intranet/">Intranet</a> si eres profesor o personal de administración y servicios.</p>
                <?php else: ?>
                <p>Puedes comprobar que tu información de contacto sean correctas, estén completas y se mantengan actualizadas en todo momento accediendo a la <a href="//<?php echo $config['dominio']; ?>/intranet/">Intranet</a> si eres profesor o personal de administración y servicios.</p>
                <?php endif; ?>
