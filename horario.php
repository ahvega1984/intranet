...
$hora_fin = $todas_horas[2];
$nombre = substr($hora_inicio,0,5)."<br>".substr($hora_fin,0,5);
$algo = 0;
for($i = 1; $i < 6; $i ++) {
...
<td>
    ...
    $asig_seneca = mysqli_query($db_con, "SELECT * FROM  asignaturas where codigo = '$rowasignatur1[0]'" );
		...
		elseif ((($rowasignatur1 [0] == "25" and $rowasignatur1 [1]!=="GUCON") or $rowasignatur1 [0] == "44") and $config['mod_horarios']) {
