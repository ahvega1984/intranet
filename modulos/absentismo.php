...
echo "<div class='alert alert-info'><button type='button' class='close' data-dismiss='alert'>&times;</button><p class='lead'><i class='far fa-bell'> </i> Informes de Absentismo</p><hr />";
