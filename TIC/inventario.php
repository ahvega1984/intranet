                        ...
                        <tr<?php echo ($item['marcadobaja']) ? ' class="danger"' : ''; ?>>
                            ...
                            <td class="text-right" nowrap>
                                ...
                                <form action="" method="post" style="display: inline; margin: 0; padding: 0;">
                                    ...
                                    <button type="submit" class="btn btn-default" name="marcarBaja" data-bs="tooltip" title="<?php echo ($item['marcadobaja']) ? 'Desmarcar para dar de baja en Séneca' : 'Marcar para dar de baja en Séneca'; ?>"><?php echo ($item['marcadobaja']) ? '<span class="far fa-undo fa-fw"></span>' : '<span class="far fa-times fa-fw"></span>'; ?></button>
                                </form>
                            </td>
                            <?php endif; ?>
                        </tr>
