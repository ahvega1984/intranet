...
var tour = new Tour({
  ...
  },
  {
    ...
    content: "Consulta las tareas que hayas marcado como pendientes. Cuando recibes un mensaje de un profesor, puede que te interese marcarlo como una tarea para realizarla en cualquier momento. En el caso de que tengas tareas pendientes, este icono cambiará de color. Para ver las tareas pendientes y realizadas, haz click en Ver todas las tareas.",
    container: "body",
    placement: "bottom",
    template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'></h3><div class='popover-content'></div><div class='popover-navigation'><button class='btn btn-default' data-role='prev'>« Anterior</button>&nbsp;<button class='btn btn-default' data-role='next'>Siguiente »</button></div></div>",
    backdrop: false,
